    ...
    stages {
        stage("Cloning the code from a Git repository") {
            ...
            steps {
                ...
                git url: "https://github.com/Aboakye2074/Jenkins-CI-CD-with-AWS-EC2.git", branch: "main"
        ...
        stage("Building and testing the Docker image") {
            ...
            steps {
                ...
                sh "docker build -t aboakye2074/my-node-app . "
        ...
        stage("Pushing to DockerHub") {
            ...
            steps {
                ...
                
                {
                    ...
                    sh "docker push aboakye2074/my-node-app"
